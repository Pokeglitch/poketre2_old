...
wMonHBaseSpecialDefense :: ;d0ce
	ds 1
	
wMonHBasePrice :: ;d0cf
	ds 1
	
wMonHEvoShedItem :: ;d0d0
	ds 1
	
wMonHGenderEggGroup::
	ds 1
	
wMonHBaseMorale :: ;d0d1
	ds 1
...
;bit 0 = if set, then we backup data when walking.  otherwise, save data when walking
