...
\1 EQUS "((\2 - \2 + \2_Pointer - SFX_Pointers) / 3)"
ENDM
	...
	music_const SFX_SNARE_1,            SFX_Snare1
	music_const SFX_SNARE_2,            SFX_Snare2
	music_const SFX_SNARE_3,            SFX_Snare3
	music_const SFX_SNARE_4,            SFX_Snare4
	music_const SFX_SNARE_5,            SFX_Snare5
	music_const SFX_TRIANGLE_1,         SFX_Triangle1
	music_const SFX_TRIANGLE_2,         SFX_Triangle2
	music_const SFX_SNARE_6,            SFX_Snare6
	music_const SFX_SNARE_7,            SFX_Snare7
	music_const SFX_SNARE_8,            SFX_Snare8
	music_const SFX_SNARE_9,            SFX_Snare9
	music_const SFX_CYMBAL_1,           SFX_Cymbal1
	music_const SFX_CYMBAL_2,           SFX_Cymbal2
	music_const SFX_CYMBAL_3,           SFX_Cymbal3
	music_const SFX_MUTED_SNARE_1,      SFX_Muted_Snare1
	music_const SFX_TRIANGLE_3,         SFX_Triangle3
	music_const SFX_MUTED_SNARE_2,      SFX_Muted_Snare2
	music_const SFX_MUTED_SNARE_3,      SFX_Muted_Snare3
	music_const SFX_MUTED_SNARE_4,      SFX_Muted_Snare4
	music_const SFX_CRY_00,             SFX_Cry00
	music_const SFX_CRY_01,             SFX_Cry01
	music_const SFX_CRY_02,             SFX_Cry02
	music_const SFX_CRY_03,             SFX_Cry03
	music_const SFX_CRY_04,             SFX_Cry04
	music_const SFX_CRY_05,             SFX_Cry05
	music_const SFX_CRY_06,             SFX_Cry06
	music_const SFX_CRY_07,             SFX_Cry07
	music_const SFX_CRY_08,             SFX_Cry08
	music_const SFX_CRY_09,             SFX_Cry09
	music_const SFX_CRY_0A,             SFX_Cry0A
	music_const SFX_CRY_0B,             SFX_Cry0B
	music_const SFX_CRY_0C,             SFX_Cry0C
	music_const SFX_CRY_0D,             SFX_Cry0D
	music_const SFX_CRY_0E,             SFX_Cry0E
	music_const SFX_CRY_0F,             SFX_Cry0F
	music_const SFX_CRY_10,             SFX_Cry10
	music_const SFX_CRY_11,             SFX_Cry11
	music_const SFX_CRY_12,             SFX_Cry12
	music_const SFX_CRY_13,             SFX_Cry13
	music_const SFX_CRY_14,             SFX_Cry14
	music_const SFX_CRY_15,             SFX_Cry15
	music_const SFX_CRY_16,             SFX_Cry16
	music_const SFX_CRY_17,             SFX_Cry17
	music_const SFX_CRY_18,             SFX_Cry18
	music_const SFX_CRY_19,             SFX_Cry19
	music_const SFX_CRY_1A,             SFX_Cry1A
	music_const SFX_CRY_1B,             SFX_Cry1B
	music_const SFX_CRY_1C,             SFX_Cry1C
	music_const SFX_CRY_1D,             SFX_Cry1D
	music_const SFX_CRY_1E,             SFX_Cry1E
	music_const SFX_CRY_1F,             SFX_Cry1F
	music_const SFX_CRY_20,             SFX_Cry20
	music_const SFX_CRY_21,             SFX_Cry21
	music_const SFX_CRY_22,             SFX_Cry22
	music_const SFX_CRY_23,             SFX_Cry23
	music_const SFX_CRY_24,             SFX_Cry24
	music_const SFX_CRY_25,             SFX_Cry25
	music_const SFX_CRY_26,     		SFX_Cry26
	music_const SFX_CRY_27,     		SFX_Cry27
	music_const SFX_CRY_28,     		SFX_Cry28
	music_const SFX_CRY_29,     		SFX_Cry29
	music_const SFX_CRY_2A,     		SFX_Cry2A
	music_const SFX_CRY_2B,     		SFX_Cry2B
	music_const SFX_CRY_2C,     		SFX_Cry2C
	music_const SFX_CRY_2D,     		SFX_Cry2D
	music_const SFX_CRY_2E,     		SFX_Cry2E
	music_const SFX_CRY_2F,     		SFX_Cry2F
	music_const SFX_CRY_30,     		SFX_Cry30

	music_const SFX_GET_ITEM_2,         SFX_Get_Item2
	music_const SFX_TINK,               SFX_Tink
	music_const SFX_HEAL_HP,            SFX_Heal_HP
	music_const SFX_HEAL_AILMENT,       SFX_Heal_Ailment
	music_const SFX_START_MENU,         SFX_Start_Menu
	music_const SFX_PRESS_AB,           SFX_Press_AB

	music_const SFX_GET_ITEM_1,         SFX_Get_Item1
	music_const SFX_POKEDEX_RATING,     SFX_Pokedex_Rating
	music_const SFX_GET_KEY_ITEM,       SFX_Get_Key_Item
	music_const SFX_POISONED,           SFX_Poisoned
	music_const SFX_TRADE_MACHINE,      SFX_Trade_Machine
	music_const SFX_TURN_ON_PC,         SFX_Turn_On_PC
	music_const SFX_TURN_OFF_PC,        SFX_Turn_Off_PC
	music_const SFX_ENTER_PC,           SFX_Enter_PC
	music_const SFX_SHRINK,             SFX_Shrink
	music_const SFX_SWITCH,             SFX_Switch
	music_const SFX_HEALING_MACHINE,    SFX_Healing_Machine
	music_const SFX_TELEPORT_EXIT_1,    SFX_Teleport_Exit1
	music_const SFX_TELEPORT_ENTER_1,   SFX_Teleport_Enter1
	music_const SFX_TELEPORT_EXIT_2,    SFX_Teleport_Exit2
	music_const SFX_LEDGE,              SFX_Ledge
	music_const SFX_TELEPORT_ENTER_2,   SFX_Teleport_Enter2
	music_const SFX_FLY,                SFX_Fly
	music_const SFX_DENIED,             SFX_Denied
	music_const SFX_ARROW_TILES,        SFX_Arrow_Tiles
	music_const SFX_PUSH_BOULDER,       SFX_Push_Boulder
	music_const SFX_SS_ANNE_HORN,       SFX_SS_Anne_Horn
	music_const SFX_WITHDRAW_DEPOSIT,   SFX_Withdraw_Deposit
	music_const SFX_CUT,                SFX_Cut
	music_const SFX_GO_INSIDE,          SFX_Go_Inside
	music_const SFX_SWAP,               SFX_Swap
	music_const SFX_UNUSED_3,          	SFX_Unused3 ; unused, sounds similar to SFX_SLOTS_STOP_WHEEL
	music_const SFX_PURCHASE,           SFX_Purchase
	music_const SFX_COLLISION,          SFX_Collision
	music_const SFX_GO_OUTSIDE,         SFX_Go_Outside
	music_const SFX_SAVE,               SFX_Save
	...
	music_const SFX_UNUSED,      		SFX_Unused
	music_const SFX_UNUSED_2,      		SFX_Unused2
	

CRY_SFX_START  equs "((SFX_Cry00_Pointer - SFX_Pointers) / 3)"		;index of the first cry
CRY_SFX_END    equs "((SFX_Get_Item1_Pointer - SFX_Pointers) / 3)"	;index of the first sfx after the cries
MUSIC_ID_START equs "((Music_TitleScreen_Pointer - SFX_Pointers) / 3)"	;index of the first music id